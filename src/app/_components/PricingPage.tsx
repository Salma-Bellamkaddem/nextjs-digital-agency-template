...
interface PackDetailCardProps {
  pack: PricingPack
  onRequestQuote: () => void
}

const PackDetailCard: FC<PackDetailCardProps> = ({ pack, onRequestQuote }) => {
...
const PricingPage: FC = () => {
  ...
  return (
<Box component='main' id='home-pricing' sx={{ width: '100%' }}>
      ...
      <Box sx={{ width: '100%', py: { xs: 8, md: 12 }, backgroundColor: 'background.default' }}>
        <Container>
          <Grid container spacing={3} alignItems='stretch'>
            {PRICING_PACKS.map((pack: PricingPack) => (
